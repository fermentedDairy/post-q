 ...
 *
 * <p>This exception typically signals an issue with an expected value
 ...
 *
 * <p>By extending {@code RuntimeException}, this exception allows for
 * unchecked propagation, making it suitable for runtime validation scenarios.
 */
public class InvalidMessageException extends RuntimeException {

    /**
     * Constructs a new {@code InvalidMessageException} with the specified detail message.
     *
